...
const View = (props) => {
    ...
    const getProfileData = async () => {
        try {
            const data = await axios.get(`http://127.0.0.1:8000/api/profile/${uname}`)
                .then(res => {
                    setProfile(res.data);
                    res.send(profile);
                });
    ...
    return (
        <>
        {!loading && <><h1>hi djfbhisdgfksd fsjdkfh sudfhus dofhsdjfh jhf ushu hgdfhbg kjfgh ushgs udhgiu sdhgusd hguisd ghusd ghuisdg huisdg huisdgh sidugh suidg huish</h1></>}
        {loading && <>
        <div>
                                ...
                                <Card >
                                    <CardContent >
                                        <Grid container spacing={3} >
                                            ...
                                            <Grid item xs={12} >
                                                <h2 className={classes.username}>@</h2>
